...
def solve_bayes_pinn(Rdic=None):
    ...
    if 'PINN' == Rdic['mode2update_para']:
        params_hmc, losses = BNN_EstimatePara_Utils.update_paras_by_pinn(
            nets, data, model_loss=model_loss, learning_rate=lr, update_lr=open_update_lr, step_cum2update_lr=step2update_lr,
        ...
        params_hmc = BNN_EstimatePara_Utils.update_paras_by_hamilton(
            nets, data, model_loss=model_loss, num_samples=num_samples, step_num2per_sample=L,
...
if __name__ == "__main__":
    ...
    store_file = 'BPINN_LinearPoisson1D'
