...
def print_log_test_mse_rel(mse2solu=None, rel2solu=None, mse2para=None, rel2para=None, mse2force=None,
                           rel2force=None, log_out=None):
    BPINN_Test_Log_Print.print_log_solu2testing(mse2solu, rel2solu, log_file=log_out)
    BPINN_Test_Log_Print.print_log_para2testing(mse2para, rel2para, log_file=log_out)
...
def solve_bayes_pinn(Rdic=None):
    ...
    if 'equidistance' == str.lower(Rdic['opt2sampling']):
        ...
        data["x_k"] = x_data2coef
        clean_k = k(data["x_k"])
        data["y_k"] = clean_k + noise2k
    else:
        temp1 = torch.linspace(lb, ub, 2).view(-1, 1)
        temp2 = (ub - lb) * torch.rand(N_tr_u - 2, 1) + lb
        data["x_u"] = torch.cat((temp1, temp2), dim=0)        # interior points for solution including Dirichlet boundary
    ...
    Aux_Log_Print.print_log_SNR_Solu_Para_Fside(snr2solu=snr2solu, snr2kcoef=snr2coef,
                                                snr2fside=snr2force_side, log_file=log_fileout)
    ...
    net_k = BNN_General_Approximator.General_NN_Approximator(
        NN_Model=Rdic['model'], dim_in=Rdic['indim'], hidden_units=Rdic['hidden_units'], dim_out=Rdic['outdim'],
        Input_actName=Rdic['act_name2Input'], Hidden_actName=Rdic['act_name2Hidden'],
        Output_actName=Rdic['act_name2Output'], mode2init_Weight=Rdic['initW'], mode2init_Bias=Rdic['initB'],
        float_type='float32', with_gpu=Rdic['with_gpu'], gpu_no=Rdic['gpuNo'])
    ...
    if 'PINN' == Rdic['mode2update_para']:
        params_hmc, losses = BNN_EstimatePara_Utils.update_paras_by_pinn(
            nets, data, model_loss=model_loss, learning_rate=lr, show_learning_rate=Rdic['show_lr'],
            update_lr=open_update_lr, step_cum2update_lr=step2update_lr,
        ...
        params_hmc = BNN_EstimatePara_Utils.update_paras_by_hamilton(
            nets, data, model_loss=model_loss, num_samples=num_samples, step_num2per_sample=L, show_learning_rate=Rdic['show_lr'],
            learning_rate=lr, update_lr=open_update_lr, step_cum2update_lr=step2update_lr, step_gamma2update_lr=gamma2update_lr,
    ...
    print_log_test_mse_rel(mse2solu=mse2U, rel2solu=rel2U, mse2para=mse2K, rel2para=rel2K, mse2force=mse2F,
...
if __name__ == "__main__":
    ...
    store_file = 'BPINN_NonLinearPoisson1D'
    ...
    # R['model'] = 'NET_2HIDDEN_Frozen_FF'
    # R['model'] = 'AugNET_2HIDDEN_Frozen_FF'
    # R['model'] = 'Xavier_AugNET_2HIDDEN_Frozen_FF'
    # R['model'] = 'AugNet_2Hidden_FF'
    # R['model'] = 'Xavier_AugNet_2Hidden_FF'
    # R['model'] = 'Net_2Hidden_2FF'
    # R['model'] = 'AugNet_2Hidden_2FF'
    # R['model'] = 'Modify_AugNet_2Hidden_2FF'
    # R['model'] = 'Xavier_AugNet_2Hidden_2FF'
    # R['model'] = 'Xavier_AugNet_2Hidden_Frozen_2FF'
    # R['model'] = 'Net_2Hidden_3FF'
    # R['model'] = 'AugNet_2Hidden_3FF'
    ...
    # R['model'] = 'AugNet_3Hidden_FF'
    # R['model'] = 'Xavier_AugNet_3Hidden_2FF'
    ...
    if R['model'] == 'Net_2Hidden' or R['model'] == 'Net_2Hidden_Fourier':
        R['hidden_units'] = [30, 30]
        # R['hidden_units'] = [40, 40]
    elif R['model'] == 'Net_3Hidden' or R['model'] == 'Net_3Hidden_Fourier':
