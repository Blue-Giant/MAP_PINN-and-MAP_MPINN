...
def solve_bayes_pinn(Rdic=None):
    ...
    Nin2Solu_Mesh = 50    # the number of sampled points for dealing with solution
    Nbd2Solu_Mesh = 10    # the number of sampled points for dealing with solution
    Nin2Force_Mesh = 30  # the number of sampled points for dealing with force-side
